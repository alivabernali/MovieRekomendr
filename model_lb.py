...
def train_model_default(filepath):
    ...
    for rev in revs:
        ...
        if int(r[1]) >= 5:
            ...
            cat = "negative"
        review_temp = r[2].translate(str.maketrans('', '', string.punctuation)).lower()
...
# The driver code
# Change the value of model_path to None if you want to retrain the model, otherwise finalized_model_lb.sav
