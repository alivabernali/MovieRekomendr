...
5. Next, you have two options in running `model.py`. If you want to train the model (<span style="color:red">some **Disclaimer:** text</span>: The training process takes a long time as it is being ran on a very large dataset to ensure uttmost accuracy.)
